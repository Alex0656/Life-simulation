...
{
    class PlantInedibleWichFruitsNoPoison : PlantInedible
    {
        public PlantInedibleWichFruitsNoPoison(int x, int y, Map map)
            : base(x, y, map)
        {
            Image = Image.FromFile(@"C:\Users\Алексей\source\repos\Life-simulation_02\New_new\img\InedibleWichFruit.png");
            _poison = false;
            _appearanceRate = 25;
        ...
        protected override void Spread()
        {
            ...
            if ((value == 1) && (_x < cols))
            {
                ...
                {
                    var plant = new PlantInedibleWichFruitsNoPoison(_x + 1, _y, _map);
            ...
            else if ((value == 2) && (_y < row))
            {
                ...
                {
                    var plant = new PlantInedibleWichFruitsNoPoison(_x, _y + 1, _map);
                    _map._createdPlants.Add(plant);
                }
